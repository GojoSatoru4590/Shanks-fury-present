...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://graph.org/file/a2fa0eec069814333b9ba-428e0a26fb81620a96.jpg", 
                            ABOUT_TXT.format(
                                botname = client.name,
                                ownername = ownername, 
                            )
        ...
        await query.message.reply_photo(
            photo=("https://graph.org/file/45e132e83512d7a02881c-0e1a02f881f07bd9c9.jpg"),
